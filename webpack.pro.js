...
const buildPath = 'F:/webpack-test/';
module.exports = (env, argv) => {
  const production = argv.mode === 'production';

  const buildFolder = production ? buildPath : 'dist/';
  ...
  const webpackConfig = {
    ...
    output: {
      ...
      path: path.resolve(__dirname, buildFolder +( production ? 'static' : '')),
      libraryTarget: 'umd',
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        filename: buildFolder + (production ? 'views/' : '') + 'index.html',
      ...
      new HtmlWebpackPlugin({
        filename: buildFolder + (production ? 'views/' : '') + 'login.html',
